...
public class FirstTask {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> duplicateList = numbers.stream().distinct().collect(Collectors.toList()); //удалаяю дубликааты
        System.out.println("Delete duplicate: " + duplicateList);

        List<Integer> evenList = numbers.stream().filter(val -> val % 2 == 0 && val >= 7 && val <= 17).collect(Collectors.toList());
